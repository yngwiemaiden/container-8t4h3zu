...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8t4h3zu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8t4h3zu.containers.anotherwebservice.com/
...
```
git clone git@github.com:yngwiemaiden/container-8t4h3zu.git
cd container-8t4h3zu
```
...
```
docker attach container-8t4h3zu
```
